...
## Documentation
* FunXMPP Protocol - https://github.com/milangoda/Chat-API-NET/wiki/WhatsApp-Protocol---FunXMPP

## Protocol
More info in Chat API repo wiki https://github.com/milangoda/chat-API
